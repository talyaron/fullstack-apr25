...
const dashboardMessageDiv = document.getElementById('message') as HTMLDivElement;
    ...
    productsGrid.innerHTML = products.map(product => `
        <div class="product-card">
            ...
            <div class="product-actions">
                <button class="btn btn-warning btn-small" onclick="editProduct('${product._id}')">✏️ ערוך</button>
                <button class="btn btn-danger btn-small" onclick="deleteProduct('${product._id}')">🗑️ מחק</button>
            </div>
        </div>
    `).join('');
}
