...
import type { Author, AuthorInput, BookWithAuthor, BookInput, Genre } from './types';
import { getAuthors, createAuthor, updateAuthor, deleteAuthor, getBooks, createBook, updateBook, deleteBook, getGenres } from './api';
  ...
  return (
    <div className="app">
      ...
      <div className="tabs">
        ...
        <GenreFilter genres={genres} setBooks={setBooks} setError={setError}/>
      </div>
