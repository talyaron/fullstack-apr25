class Player {
    ...
    htmlPlayer(): string {
        return `
        <div class="player" style="background-image: url(${this.img});top:${7*30}px;left:${10*30}px"">
