class FootballPlayer {
    ...
    constructor(name: string, yearOfBirth: number, position: string, team: string, domElement?: HTMLElement, imageUrl?: string) {
        this.name = name;
    ...
    render(container: HTMLElement) {
        try {
            ...
            if (!this.playerElement) throw new Error("Failed to create player element");
